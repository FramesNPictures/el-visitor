...
class CheckMobileBrowser implements VisitorUaSource
{
    public function apply(Visitor $visitor, string $ua): void
    {
        ...
        $m2  = preg_match(
            ...
            '|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)' .
            '|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi' .
            '|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw' .
            '|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o' .
            '|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8' .
            '|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560' .
            '|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie' .
            '|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)' .
            '|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)' .
            ...
            '|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa' .
            '|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)' .
            '|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|' .
            'op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))' .
            '|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio' .
            '|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek' .
            ...
            '|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)' .
